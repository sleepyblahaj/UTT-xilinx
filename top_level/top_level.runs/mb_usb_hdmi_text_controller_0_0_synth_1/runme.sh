...
HD_PWD='F:/UTT-xilinx/top_level/top_level.runs/mb_usb_hdmi_text_controller_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_usb_hdmi_text_controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_usb_hdmi_text_controller_0_0.tcl

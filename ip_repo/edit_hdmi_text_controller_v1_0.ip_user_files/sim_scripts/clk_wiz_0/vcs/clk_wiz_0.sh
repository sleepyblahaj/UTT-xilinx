...
#
# Generated by Vivado on Sat Nov 15 22:04:30 -0600 2025
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../hdmi_text_controller_1_0/src/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../hdmi_text_controller_1_0/src/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
